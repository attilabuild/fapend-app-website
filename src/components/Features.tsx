...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: 'Keep track of your NoFap streak with daily counters, milestone achievements, and progress analytics.',
      icon: (
    ...
    },
    {
      ...
      description: 'Get daily motivation quotes, success stories, and scientifically-backed benefits of NoFap.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: 'Urge Control',
      description: 'Access emergency motivation and techniques to overcome urges in critical moments of temptation.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: 'Connect with thousands of others on the same journey, share experiences, and get support.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: 'Goal Setting',
      description: 'Set personal goals, track habits, and develop healthier routines to replace unwanted behaviors.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: 'Detailed insights into your progress, patterns, triggers, and improvements over time.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section ref={sectionRef} className="w-full bg-primary py-20 overflow-hidden" id="features">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className={`bg-secondary p-6 rounded-lg transition-all duration-700 ease-out hover:bg-opacity-70 hover:transform hover:scale-105 hover:shadow-lg cursor-pointer ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
              style={{ transitionDelay: `${index * 150}ms` }}
            >
              <div className="text-accent mb-4 transform hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
