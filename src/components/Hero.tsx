      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 mt-20">
            ...
            <div 
              ref={buttonsRef}
              className="flex flex-col sm:flex-row justify-center gap-4 mb-12 opacity-0 translate-y-8 transition-all duration-1000 ease-out delay-500"
            >
              <Link
                href="https://apps.apple.com/rs/app/pureresist-quit-corn-now/id6745742828" 
                className="bg-[#0066FF] text-white px-8 py-3 rounded-lg font-medium transform hover:scale-105 transition-all duration-300 hover:shadow-lg flex items-center justify-center"
                target="_blank"
              ...
              <Link
                href="/waitlist"
                className="bg-[#1F1F1F] text-white px-8 py-3 rounded-lg font-medium transform hover:scale-105 transition-all duration-300 hover:shadow-lg flex items-center justify-center border border-gray-800"
              >
